import tools.transforms.transforms as ops
import inspect
...
NAME_TO_FUNC = {
    ...
    'Cutout': ops.cutout,
    'BBox_Cutout': ops.bbox_cutout,
    'Rotate_BBox': ops.rotate_with_bboxes,
    # pylint:disable=g-long-lambda
    'TranslateX_BBox': lambda image, bboxes, pixels, replace: ops.translate_bbox(
        image, bboxes, pixels, replace, shift_horizontal=True),
    'TranslateY_BBox': lambda image, bboxes, pixels, replace: ops.translate_bbox(
        image, bboxes, pixels, replace, shift_horizontal=False),
    'ShearX_BBox': lambda image, bboxes, level, replace: ops.shear_with_bboxes(
        image, bboxes, level, replace, shear_horizontal=True),
    'ShearY_BBox': lambda image, bboxes, level, replace: ops.shear_with_bboxes(
        image, bboxes, level, replace, shear_horizontal=False),
    # pylint:enable=g-long-lambda
    'Rotate_Only_BBoxes': ops.rotate_only_bboxes,
    'ShearX_Only_BBoxes': ops.shear_x_only_bboxes,
    'ShearY_Only_BBoxes': ops.shear_y_only_bboxes,
    'TranslateX_Only_BBoxes': ops.translate_x_only_bboxes,
    'TranslateY_Only_BBoxes': ops.translate_y_only_bboxes,
    'Flip_Only_BBoxes': ops.flip_only_bboxes,
    'Solarize_Only_BBoxes': ops.solarize_only_bboxes,
    'Equalize_Only_BBoxes': ops.equalize_only_bboxes,
    'Cutout_Only_BBoxes': ops.cutout_only_bboxes,
}
